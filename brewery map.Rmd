...
I created the package _uszipcodes_ and it is available in my [_github_](https://github.com/li-wen-li/uszipcodes). It includes zip code location data and some functions to clean data.
